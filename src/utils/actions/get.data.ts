...
// /objects?pretty=true&query=%7B%22type%22%3A%22pages%22%7D&limit=10&skip=0&read_key=buKB1W23v4IDKwey4AVUIbpJoQJjXq7DRpBQHSw96AJvevBBgs&depth=1&props=slug%2Ctitle&sort=-order

// /objects?pretty=true&query=%7B%22type%22:%22pages%22%7D&limit=10&skip=0&read_key=${process.env.READ_KEY}&depth=1&props=slug,title,
